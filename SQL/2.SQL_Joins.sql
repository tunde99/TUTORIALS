...
JOIN accounts
ON sales_reps_name.id = accounts.sales_rep_id
...
quantity exceeds 100 and the poster order quantity exceeds 50. Your final table should 
...
only 2 columns: account name and the different channels. You can try SELECT DISTINCT to narrow down 
